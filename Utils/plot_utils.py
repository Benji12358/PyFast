...
def plot_2D_contours_with_spot(array2D, spot2D, mesh:CFD_mesh, settings:Settings):
    ...
    fig.chg_x_axis(r'$X$',axis_low_bound=0,axis_high_bound=settings.L1)
    fig.chg_y_axis(r'$Z$',axis_low_bound=0-settings.L3/2,axis_high_bound=settings.L3-settings.L3/2)
    fig.custom_layout()
    fig.display()