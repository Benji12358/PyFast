...
class Settings:
    ...
    def __init__(self, path_settings):
        ...
        # initialize boolean for 2D contour plotting
        ...
        # initialize boolean for statistics plotting
    ...
    def gather_information(self):
        ...
        self.get_T = self.plot_T_instantaneous or self.plot_T_fluctuations \
                            or self.plot_TEHL_T_fluctuations or self.plot_wall_temperature_flux_contours \
                            or self.plot_TEHL_wall_temperature_flux_contours or self.compute_temperature_stats \
        ...
        self.plot_TEHL = self.plot_TEHL_U_fluctuations or self.plot_TEHL_V_fluctuations \
                            or self.plot_TEHL_W_fluctuations or self.plot_TEHL_wall_shear_stress_contours \
                            or self.plot_TEHL_wall_temperature_flux_contours or self.plot_TEHL_velocity_stats \
                            or self.plot_TEHL_transport_equation_terms or self.plot_TEHL_reynolds_stresses \
                            or self.plot_TEHL_temperature_stats or self.plot_TEHL_temperature_velocity_correlations
